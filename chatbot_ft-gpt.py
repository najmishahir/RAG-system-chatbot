...
os.environ["LANGCHAIN_PROJECT"] = "final-year-proj-fine-tune"
...
def main():
    ...
    if input_text := st.chat_input("How can I help?"):
        ...
        with st.chat_message("assistant"):
            ...
            llm = ChatOpenAI(temperature=0.2, model_name="ft:gpt-3.5-turbo-0125:personal:final-year-proj:9HJd9vzL")
